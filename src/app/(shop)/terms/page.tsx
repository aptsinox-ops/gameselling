...
export default function TermsOfService() {
  return (
    <main style={{ maxWidth: "850px", margin: "0 auto", padding: "40px 20px", fontFamily: "sans-serif", lineHeight: "1.6" }}>
      ...
      <ul>
        ...
        <li>
          <p><strong>Country/State</strong> refers to: Bangladesh</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Zebo Topup LLC, Jalkuri House 1425.</p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            <a href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <p><strong>Website</strong> refers to Zebo Topup, accessible from <a href="https://zebotopup.store" target="_blank" rel="noopener noreferrer">zebotopup.store</a></p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: <a href="mailto:zebotopup@gmail.com">zebotopup@gmail.com</a></p>
        </li>
        <li>
          <p>By visiting this page on our website: <a href="https://zebotopup.store" target="_blank" rel="noopener noreferrer">zebotopup.store</a></p>
        </li>
      </ul>
    </main>
  );
