...
export default function HeroSlider({ noticeText }: HeroSliderProps) {
  ...
  return (
    <div className="w-full space-y-4 block clear-both select-none">
      ...
      {/* Hero Slider Container (Height increases to fit full banner) */}
            ...
            >
              ...
              {slide.type === "SOCIAL" && (
                ...
                >
                  ...
                  {/* 🎯 PC & Mobile: Bottom-Right Aligned Animation Box */}
                  {isActive && (
      ...
      {/* Telegram Support & Group Buttons */}
